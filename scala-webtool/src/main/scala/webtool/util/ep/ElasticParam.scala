...
case class ElasticParam(implicit ms: MkString) {
...
//object ElasticParam {
//  def apply(parameters: Map[String, Any])(implicit ms: MkString): ElasticParam = {
//    val ep = ElasticParam()(ms)
//    ep ++= parameters
//    ep
//  }
//
//  def apply(parameters: Map[String, Any], datasets: List[Dataset])(implicit ms: MkString): ElasticParam = {
//    val ep = ElasticParam()(ms)
//    ep ++= parameters
